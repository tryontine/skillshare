...
export function SearchBar({
  ...
  return (
    ...
    >
      <label
        className={cn(
          "flex min-w-0 items-center gap-3 rounded-[18px] bg-surface px-4 py-3 transition focus-within:outline-none focus-within:ring-2 focus-within:ring-alpine",
      ...
      <select className="transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-alpine" defaultValue="all" aria-label="Filter by category">
        <option value="all">All categories</option>
        <option value="language-coaching">Language coaching</option>
        <option value="tutoring">Tutoring</option>
        <option value="fitness">Fitness</option>
      </select>
      <select className="transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-alpine" defaultValue="Zurich" aria-label="Filter by city">
