...
export function SearchBar({
  ...
  return (
    ...
    >
      ...
      <select className="transition duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-alpine" defaultValue="all" aria-label="Filter by category">
        <option value="all">All categories</option>
        <option value="language-coaching">Language coaching</option>
        <option value="tutoring">Tutoring</option>
        <option value="fitness">Fitness</option>
      </select>
      <select className="transition duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-alpine" defaultValue="Zurich" aria-label="Filter by city">
