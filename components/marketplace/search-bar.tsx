...
export function SearchBar({
  ...
  return (
    ...
    >
      <label
        className={cn(
          "flex min-w-0 items-center gap-3 rounded-[18px] bg-surface px-4 py-3 focus-within:ring-2 focus-within:ring-alpine focus-within:outline-none transition duration-300",
